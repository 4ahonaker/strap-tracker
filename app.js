...
function maybeShowWhatsNew(){
  ...
  if(closeX){
    closeX.addEventListener("click", (e)=>{ e.preventDefault(); e.stopPropagation(); dismiss(); }, { once:true });
    closeX.addEventListener("touchend", (e)=>{ e.preventDefault(); e.stopPropagation(); dismiss(); }, { once:true });
  }
